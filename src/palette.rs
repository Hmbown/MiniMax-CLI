...
pub const MINIMAX_RED: Color =
    Color::Rgb(MINIMAX_RED_RGB.0, MINIMAX_RED_RGB.1, MINIMAX_RED_RGB.2);
...
pub const MINIMAX_INK: Color =
    Color::Rgb(MINIMAX_INK_RGB.0, MINIMAX_INK_RGB.1, MINIMAX_INK_RGB.2);
pub const MINIMAX_BLACK: Color =
    Color::Rgb(MINIMAX_BLACK_RGB.0, MINIMAX_BLACK_RGB.1, MINIMAX_BLACK_RGB.2);
pub const MINIMAX_SLATE: Color =
    Color::Rgb(MINIMAX_SLATE_RGB.0, MINIMAX_SLATE_RGB.1, MINIMAX_SLATE_RGB.2);
pub const MINIMAX_SILVER: Color =
    Color::Rgb(MINIMAX_SILVER_RGB.0, MINIMAX_SILVER_RGB.1, MINIMAX_SILVER_RGB.2);
pub const MINIMAX_SNOW: Color =
    Color::Rgb(MINIMAX_SNOW_RGB.0, MINIMAX_SNOW_RGB.1, MINIMAX_SNOW_RGB.2);
pub const MINIMAX_GREEN: Color =
    Color::Rgb(MINIMAX_GREEN_RGB.0, MINIMAX_GREEN_RGB.1, MINIMAX_GREEN_RGB.2);
